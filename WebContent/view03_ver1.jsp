...
<br>
	...
	<tr>
		<td>
			<ul style="list-style:none">
				<li><a href=""><img src=${image1} width="200" height="200" alt="이미지를 업로드해주세요"></a></li>
				<li> ${group_name1} </li>
				<li> ${interest1} </li>
				<li> ${state1} </li>
			</ul>
		...
		<td>
			<ul style="list-style:none">
				<li><a href=""><img src=${image2} width="200" height="200" alt="이미지를 업로드해주세요"></a></li>
				<li> ${group_name2} </li>
				<li> ${interest2} </li>
				<li> ${state2} </li>
			</ul>
		...
		<td>
			<ul style="list-style:none">
				<li><a href=""><img src=${image3} width="200" height="200" alt="이미지를 업로드해주세요"></a></li>
				<li> ${group_name3} </li>
				<li> ${interest3} </li>
				<li> ${state3} </li>
			</ul>
	...
	<tr>
		<td>
			<ul style="list-style:none">
				<li><a href=""><img src=${image4} width="200" height="200" alt="이미지를 업로드해주세요"></a></li>
				<li> ${group_name4} </li>
				<li> ${interest4} </li>
				<li> ${state4} </li>
			</ul>
		...
		<td>
			<ul style="list-style:none">
				<li><a href=""><img src=${image5} width="200" height="200" alt="이미지를 업로드해주세요"></a></li>
				<li> ${group_name5} </li>
				<li> ${interest5} </li>
				<li> ${state5} </li>
		...
		<td>
			<ul style="list-style:none">
				<li><a href=""><img src= ${image6} width="200" height="200" alt="이미지를 업로드해주세요"></a></li>
				<li> ${group_name6} </li>
				<li> ${interest6} </li>
				<li> ${state6} </li>
			</ul>
